...
const GlowCard: React.FC<GlowCardProps> = ({ children, identifier }) => {
  ...
  return (
    <div className={`glow-container-${identifier} glow-container`}>
      <article
        className={`glow-card glow-card-${identifier} h-fit cursor-pointer border  transition-all duration-300 relative bg-background text-foreground rounded-xl hover:border-transparent w-full`}
      >
