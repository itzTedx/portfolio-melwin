...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-12 lg:max-w-4xl lg:px-8 lg:py-16 xl:max-w-6xl">
      <article>
        <h1 className="sr-only">Tailwind CSS Typography</h1>
        <div className="space-y-10 sm:space-y-12 lg:space-y-20 xl:space-y-24">
          <div className="space-y-10 sm:flex sm:items-center sm:justify-between sm:space-y-0">
            ...
            <div>
              <a
                ...
                className="inline-flex items-center space-x-2 rounded-md bg-gray-800 px-3 py-2 text-sm font-medium leading-5 text-gray-300 shadow-lg transition duration-100 ease-in-out hover:bg-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
              >
                <svg
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg xl:prose-xl 2xl:prose-2xl dark:prose-invert mx-auto">
            <p>
              ...
              temporibus unde hic saepe rem magni. Est, iusto consequuntur
              tempora, veniam odit beatae atque numquam necessitatibus nam,
              praesentium error id sit. Praesentium aperiam, quo laboriosam
              nesciunt eaque tempora eligendi voluptatibus corporis natus ad
              obcaecati, hic, iusto itaque nemo? Impedit, praesentium quam vero
              incidunt, asperiores vitae ab illo eum amet harum ea. Nobis nulla
              quaerat officiis vero odit maiores quo, officia quas ab quod.
              Libero ab, ratione eius dolores sapiente magnam enim dolorum, odit
              dicta nihil itaque quae! Nemo dolore odio sed? Nemo, sapiente,
              labore voluptates dolore soluta ipsam inventore minima dolores
              esse dicta dolorum quam illum alias ut architecto ullam rem
              doloremque ea perferendis. Expedita incidunt odio numquam impedit
              aperiam consequatur. Mollitia aspernatur, error reprehenderit aut
              quos odio sequi nihil ratione rerum autem neque magni repudiandae
              ea consequatur impedit repellendus asperiores. Quisquam a iste
              officiis facere facilis in enim illo aspernatur!
            </p>
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Omnis,
              temporibus unde hic saepe rem magni. Est, iusto consequuntur
