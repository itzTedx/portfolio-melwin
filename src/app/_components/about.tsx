    ...
    <div id="about" className="py-12 lg:py-16 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="order-2 lg:order-1">
          ...
          <p className="text-pretty text-foreground text-sm lg:text-lg flex gap-4 mb-4">
          ...
          <p className="text-pretty text-foreground text-sm lg:text-lg flex gap-4 relative">
            <span className="size-4 rounded-full  shadow-sm flex items-center justify-center relative mt-px md:mt-2 ">
              <span className="size-3 absolute rounded-full border border-primary animate-ping" />
